...
# Main code executionSkillMingle/media/cv/DiyaAdhikary_IBM_CV (1).pdf
pdf_path = "//workspaces//Final_Year_Project//SkillMingle//media//cv//DiyaAdhikary_IBM_CV (1).pdf"
